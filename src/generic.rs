...
macro_rules! raw_reg {
    ($U:ty, $size:literal, $mask:ident) => {
        ...
        const fn $mask<const WI: u8>() -> $U { <$U>::MAX >> ($size - WI) }
...
impl<REG: RegisterSpec, FI> PartialEq<FI> for R<REG>
    where REG::Ux: PartialEq,
          FI: Copy,
          REG::Ux: From<FI>,
{
    #[inline(always)]
    fn eq(&self, other: &FI) -> bool { self.bits.eq(&REG::Ux::from(*other)) }
}
/// Register writer.
///
...
impl<FI: FieldSpec> FieldReader<FI> {
    ...
    #[inline(always)]
    pub const fn bits(&self) -> FI::Ux { self.bits }
}
...
impl<FI> PartialEq<FI> for FieldReader<FI> where FI: FieldSpec + Copy, {
    #[inline(always)]
    fn eq(&self, other: &FI) -> bool { self.bits.eq(&FI::Ux::from(*other)) }
}
...
{
    #[inline(always)]
    fn eq(&self, other: &FI) -> bool { self.bits.eq(&bool::from(*other)) }
}
impl<FI> BitReader<FI> {
    /// Value of the field as raw bits.
    #[inline(always)]
    pub const fn bit(&self) -> bool { self.bits }

    /// Returns `true` if the bit is clear (0).
    #[inline(always)]
    pub const fn bit_is_clear(&self) -> bool { !self.bit() }

    /// Returns `true` if the bit is set (1).
    #[inline(always)]
    pub const fn bit_is_set(&self) -> bool { self.bit() }
}
          ...
          FI: FieldSpec,
{
    ...
    /// Field width
    #[inline(always)]
    pub const fn width(&self) -> u8 { WI }

    /// Field offset
    #[inline(always)]
    pub const fn offset(&self) -> u8 { self.o }
}
          ...
          REG::Ux: From<FI::Ux>,
{
    /// Writes raw bits to the field
    #[inline(always)]
    pub fn set(self, value: FI::Ux) -> &'a mut W<REG> { unsafe { self.bits(value) } }
}
...
macro_rules! bit_proxy {
    ($writer:ident, $mwv:ident) => {
                  ...
                  bool: From<FI>,
        {
            ...
            /// Writes `variant` to the field
            #[inline(always)]
            pub fn variant(self, variant: FI) -> &'a mut W<REG> { self.bit(bool::from(variant)) }
        }
    };
}
...
impl<REG: RegisterSpec> Reg<REG> {
    ...
    /// ```
    #[inline(always)]
    pub fn as_ptr(&self) -> *mut REG::Ux { self.register.as_ptr() }
}
...
impl<REG: Resettable + Writable> Reg<REG> {
    ...
    #[inline(always)]
    pub fn reset(&self) { self.register.set(REG::RESET_VALUE) }
    ...
    pub fn write<F>(&self, f: F) -> REG::Ux
        ...
        let value = f(&mut W { bits: REG::RESET_VALUE & !REG::ONE_TO_MODIFY_FIELDS_BITMAP
    ...
    pub fn from_write<F, T>(&self, f: F) -> T
        ...
        let mut writer = W { bits: REG::RESET_VALUE & !REG::ONE_TO_MODIFY_FIELDS_BITMAP
                                   | REG::ZERO_TO_MODIFY_FIELDS_BITMAP,
...
impl<REG: Readable + Writable> Reg<REG> {
    ...
    pub fn modify<F>(&self, f: F) -> REG::Ux
        ...
        let value = f(&R { bits, _reg: marker::PhantomData },
                      &mut W { bits: bits & !REG::ONE_TO_MODIFY_FIELDS_BITMAP
                                     | REG::ZERO_TO_MODIFY_FIELDS_BITMAP,
                               _reg: marker::PhantomData }).bits;
        self.register.set(value);
        value
    ...
    pub fn from_modify<F, T>(&self, f: F) -> T
        ...
        let bits = self.register.get();
        let mut writer = W { bits: bits & !REG::ONE_TO_MODIFY_FIELDS_BITMAP
                                   | REG::ZERO_TO_MODIFY_FIELDS_BITMAP,
                             _reg: marker::PhantomData };
...
impl<REG: Readable> core::fmt::Debug for crate::generic::Reg<REG> where R<REG>: core::fmt::Debug, {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
