/// Register `CIACRB` reader
pub type R = crate::R<CiacrbSpec>;
/// Register `CIACRB` writer
pub type W = crate::W<CiacrbSpec>;
...
impl W {
    ...
    /// count immediately.
    #[inline(always)]
    pub fn start_timer(&mut self) -> StartTimerW<'_, CiacrbSpec> { StartTimerW::new(self, 0) }

    /// Bit 1 - Route timer B underflow onto PB7
    #[inline(always)]
    pub fn select_timer_output(&mut self) -> SelectTimerOutputW<'_, CiacrbSpec> {
        SelectTimerOutputW::new(self, 1)
    }

    /// Bit 2 - PB7 output waveform on timer B underflow
    #[inline(always)]
    pub fn port_output_mode(&mut self) -> PortOutputModeW<'_, CiacrbSpec> {
        PortOutputModeW::new(self, 2)
    }

    /// Bit 3 - Timer B reload behavior after underflow
    #[inline(always)]
    pub fn timer_run_mode(&mut self) -> TimerRunModeW<'_, CiacrbSpec> {
    ...
    /// SIDE-EFFECT: writing Load copies the latch into the counter immediately.
    #[inline(always)]
    pub fn force_latched_load(&mut self) -> ForceLatchedLoadW<'_, CiacrbSpec> {
        ForceLatchedLoadW::new(self, 4)
    }

    /// Bits 5:6 - What timer B counts
    #[inline(always)]
    pub fn timer_input_mode(&mut self) -> TimerInputModeW<'_, CiacrbSpec> {
        TimerInputModeW::new(self, 5)
    }

    /// Bit 7 - Selects what TOD register writes set: clock or alarm
    #[inline(always)]
    pub fn tod_write_mode(&mut self) -> TodWriteModeW<'_, CiacrbSpec> {
        TodWriteModeW::new(self, 7)
    }
}
/// Control register B
///
/// You can [`read`](crate::Reg::read) this register and get [`ciacrb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ciacrb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct CiacrbSpec;
impl crate::RegisterSpec for CiacrbSpec {
    type Ux = u8;
}
/// `read()` method returns [`ciacrb::R`](R) reader structure
impl crate::Readable for CiacrbSpec {}
/// `write(|w| ..)` method takes [`ciacrb::W`](W) writer structure
impl crate::Writable for CiacrbSpec {
    type Safety = crate::Unsafe;
}
/// `reset()` method sets CIACRB to value 0
impl crate::Resettable for CiacrbSpec {}
