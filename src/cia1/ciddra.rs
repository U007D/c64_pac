/// Register `CIDDRA` reader
pub type R = crate::R<CiddraSpec>;
/// Register `CIDDRA` writer
pub type W = crate::W<CiddraSpec>;
...
impl W {
    /// Bit 0 - Direction of Data Port A bit 0
    #[inline(always)]
    pub fn line0(&mut self) -> Line0W<'_, CiddraSpec> { Line0W::new(self, 0) }

    /// Bit 1 - Direction of Data Port A bit 1
    #[inline(always)]
    pub fn line1(&mut self) -> Line1W<'_, CiddraSpec> { Line1W::new(self, 1) }

    /// Bit 2 - Direction of Data Port A bit 2
    #[inline(always)]
    pub fn line2(&mut self) -> Line2W<'_, CiddraSpec> { Line2W::new(self, 2) }

    /// Bit 3 - Direction of Data Port A bit 3
    #[inline(always)]
    pub fn line3(&mut self) -> Line3W<'_, CiddraSpec> { Line3W::new(self, 3) }

    /// Bit 4 - Direction of Data Port A bit 4
    #[inline(always)]
    pub fn line4(&mut self) -> Line4W<'_, CiddraSpec> { Line4W::new(self, 4) }

    /// Bit 5 - Direction of Data Port A bit 5
    #[inline(always)]
    pub fn line5(&mut self) -> Line5W<'_, CiddraSpec> { Line5W::new(self, 5) }

    /// Bit 6 - Direction of Data Port A bit 6
    #[inline(always)]
    pub fn line6(&mut self) -> Line6W<'_, CiddraSpec> { Line6W::new(self, 6) }

    /// Bit 7 - Direction of Data Port A bit 7
    #[inline(always)]
    pub fn line7(&mut self) -> Line7W<'_, CiddraSpec> { Line7W::new(self, 7) }
}
/// Port A data direction (1 = output)
///
/// You can [`read`](crate::Reg::read) this register and get [`ciddra::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ciddra::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).
pub struct CiddraSpec;
impl crate::RegisterSpec for CiddraSpec {
    type Ux = u8;
}
/// `read()` method returns [`ciddra::R`](R) reader structure
impl crate::Readable for CiddraSpec {}
/// `write(|w| ..)` method takes [`ciddra::W`](W) writer structure
impl crate::Writable for CiddraSpec {
    type Safety = crate::Unsafe;
}
/// `reset()` method sets CIDDRA to value 0
impl crate::Resettable for CiddraSpec {}
