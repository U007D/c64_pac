/// Register `SPSPCL` reader
pub type R = crate::R<SpspclSpec>;
/// Sprite %s collided with another sprite
///
/// Value on reset: 0
...
/// Field `SPRITE(0-7)` reader - Sprite %s collided with another sprite
...
impl R {
    /// Sprite (0-7) collided with another sprite
    ///
...
pub struct SpspclSpec;
impl crate::RegisterSpec for SpspclSpec {
    type Ux = u8;
}
/// `read()` method returns [`spspcl::R`](R) reader structure
impl crate::Readable for SpspclSpec {}
/// `reset()` method sets SPSPCL to value 0
impl crate::Resettable for SpspclSpec {}
